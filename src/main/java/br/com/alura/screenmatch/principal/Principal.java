...
public class Principal {
    ...
    private void buscarEpisodioPorSerie() {
        ...
        if (serie.isPresent()) {
            ...
            System.out.printf("Serie não encontrada!");
        }
    }
    ...
    private void buscaSeriePorTitutlo() {
    ...
    private void bucarEpisodioDepoisDeUmaData() {
        buscaSeriePorTitutlo();
        if (serieBusca.isPresent()) {
            Serie serie = serieBusca.get();
